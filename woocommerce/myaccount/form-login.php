		...
		<div class="form-container">
			...
			<form class="df-form df-login woocommerce-form woocommerce-form-login login" method="post">
				...
				<div class="form-group">
					<input type="text" class="form-control woocommerce-Input woocommerce-Input--text" name="username" id="username" placeholder="<?php esc_html_e( 'Username / Email*', 'domenicafiore' ); ?>" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
				</div>
	...
	<div class="col-12 col-sm-6">
		...
		<div class="form-container">
			...
			<form method="post" class="df-form df-register register">
				...
				<div class="form-group">
					<input type="email" class="form-control woocommerce-Input woocommerce-Input--text" name="email" id="reg_email" placeholder="<?php esc_html_e( 'Email*', 'domenicafiore' ); ?>" value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( wp_unslash( $_POST['email'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
				</div>
				...
				<p class="woocommerce-FormRow form-row">
					...
					<input type="submit" class="btn btn-form-submit woocommerce-Button" name="register" value="<?php esc_attr_e( 'Create', 'domenicafiore' ); ?>" />
				</p>
