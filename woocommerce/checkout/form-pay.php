...
<form id="order_review" method="post">
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'domenicafiore' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'domenicafiore' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'domenicafiore' ); ?></th>
			</tr>
		</thead>
		<tbody>
