...
<?php else : ?>
	...
	<p><?php __( "Your pre-order has been received. You will be notified when your pre-order is ready for shipping. Your order details are shown below for your reference.", 'domenicafiore' ) ?></p>
