...
function is_black_friday_product($product, $child_product, $product_name) {
	if ( $product->get_slug() === 'black-friday-sale' ) {
		if ( $product_name === 'reserva' && $child_product->get_id() === 4861 )
			return true;
		if ( $product_name === 'novello' && $child_product->get_id() === 7470 )
			return true;
	}
	return false;
}
...
<div class="row grouped">
	...
	<?php if ( $product->get_slug() === 'black-friday-sale' ) : ?>
		<div class="col-12">
			<!-- Black Friday Sale: Product Info -->
			<div class="product-text-columns row">
				<?php foreach ( $grouped_products as $grouped_product ) : $child = wc_get_product( get_post( $grouped_product->get_id() )->ID ); ?>
					<?php if ( is_black_friday_product($product, $child, 'reserva') ) : ?>
					...
					<?php elseif ( is_black_friday_product($product, $child, 'novello') ) : ?>
						<div class="product-text-column col-6">
							<h5>Novello</h5>
	...
	<div class="df-product-add-to-cart-module <?php if ( $child_count == 1 ) { echo 'col-12'; } elseif ( $child_count == 2 ) { echo 'col-6'; } elseif ( $child_count == 3 ) { echo 'col-6 col-sm-4'; } elseif ( $child_count == 4 ) { echo 'col-6 col-sm-3'; } elseif ( $child_count > 4 ) { echo 'col-6'; } ?>">
		<?php if ( get_field('show_grouped_product_column', $child->get_id()) ) : $product_column_content = get_field('grouped_product_column', $child->get_id()); ?>
	...
	<?php if ( $product->get_slug() === 'black-friday-sale' ) : ?>
		<!-- Black Friday Sale: Product Details -->
		<div class="col-12 black-friday-product-details">
						...
						<div class="df-product-details-table-column col-6">
							...
							<?php if ( is_black_friday_product($product, $child, 'reserva') ) : ?>
								<div class="certification-logos">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/certifications/Canada_Organic.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/certifications/USDA_Organic.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/certifications/EU_Certification.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/certifications/DOP.png">
								</div>
							<?php elseif ( is_black_friday_product($product, $child, 'novello') ) : ?>
								<div class="certification-logos">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/certifications/Canada_Organic.png">
						...
						<div class="df-product-details-table-column col-6">
							...
							<?php if ( is_black_friday_product($product, $child, 'reserva') ) : ?>
								<div class="award-logos">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/NYIOOC_Gold_2020.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/Athena_DoubleGold_2020.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/EVO_IOOC_Gold_2020.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/Olive_Japan_Gold_2020.png">
								</div>
							<?php elseif ( is_black_friday_product($product, $child, 'novello') ) : ?>
								<div class="award-logos">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/NYIOOC_Gold_2020.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/Athena_Gold_2020.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/EVO_IOOC_Gold_2020.png">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/black-friday-sale/awards/Olive_Japan_Gold_2020.png">
								</div>
							<?php endif; ?>
