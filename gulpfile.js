...
gulp.task('sass-admin', function () {
    var stream = gulp.src('./sass-admin/*.scss')
        .pipe(plumber({
            errorHandler: function (err) {
                console.log(err);
                this.emit('end');
...
gulp.task('watch', function () {
    ...
    gulp.watch('./sass-admin/**/*.scss', ['admin-styles']);
...
gulp.task('minify-css-admin', function() {
  return gulp.src('./css/df-admin-styles.css')
  .pipe(sourcemaps.init({loadMaps: true}))
    .pipe(cleanCSS({compatibility: '*'}))
    .pipe(plumber({
            errorHandler: function (err) {
...
gulp.task('admin-styles', function(callback){ gulpSequence('sass-admin', 'minify-css-admin')(callback) });
